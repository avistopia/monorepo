# Generated by Django 4.2.9 on 2025-02-23 14:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("base_easy_buy", models.FloatField(default=75.0)),
                ("base_medium_buy", models.FloatField(default=125.0)),
                ("base_hard_buy", models.FloatField(default=200.0)),
            ],
        ),
        migrations.CreateModel(
            name="Team",
            fields=[
                ...
                (
                    "competition",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="transaction.competition"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("team", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="transaction.team")),
            ],
        ),
        migrations.AddField(
            model_name="user",
            ...
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="transaction.competition"
            ),
        ),
        migrations.AddField(
            model_name="user",
